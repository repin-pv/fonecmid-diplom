...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Пока Выборка.Следующий() Цикл
		...
		// регистр ВКМ_ВыполненныеКлиентуРаботы Расход	
			...
			Движение.КоличествоЧасов = ТекСтрокаВыполненныеРаботы.ВКМ_ЧасыКОплатеКлиенту;
		...
		// регистр ВКМ_ВыполненныеСотрудникомРаботы Расход
			...
			Движение.ЧасовКОплате = ТекСтрокаВыполненныеРаботы.ВКМ_ЧасыКОплатеКлиенту;
			Движение.СуммаКОплате = ТекСтрокаВыполненныеРаботы.ВКМ_ЧасыКОплатеКлиенту * Выборка.СтоимостьЧаса 
